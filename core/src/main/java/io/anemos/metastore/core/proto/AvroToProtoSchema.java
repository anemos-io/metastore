...
public class AvroToProtoSchema {
    ...
    private DescriptorProtos.DescriptorProto.Builder getFields(DescriptorProtos.DescriptorProto.Builder descriptor, JsonNode fields) {
        int i = 1;
        for (JsonNode field : fields) {
            ...
            //CASE ENUM
                ...
                for (JsonNode symbol: symbols){
                    DescriptorProtos.EnumValueDescriptorProto.Builder enumValueDescriptorProto = DescriptorProtos.EnumValueDescriptorProto.newBuilder();
                ...
                fieldDescriptorProtoBuilder.setLabel(DescriptorProtos.FieldDescriptorProto.Label.LABEL_OPTIONAL);
                fieldDescriptorProtoBuilder.setTypeName(this.node.path("namespace").asText()
                        .concat(".")
