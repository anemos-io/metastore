...
/**
 * A StorageProvider needs to implement this interface, it simply will enable storing and
 * loading the full ProtoDescriptorSet blob. This makes Metastore extensible so it can be
