...
public class OptionDiffTest {
    ...
    public void addMessageOptionTest() throws IOException {
        ...
        Assert.assertEquals(OptionChangeInfo.OptionChangeType.OPTION_ADDED, optionChangeInfo.getChangeType());
    ...
    public void removeMessageOptionTest() throws IOException {
        ...
        Assert.assertEquals(OptionChangeInfo.OptionChangeType.OPTION_REMOVED, optionChangeInfo.getChangeType());
        Assert.assertEquals(OptionChangeInfo.OptionType.MESSAGE_OPTION, optionChangeInfo.getType());
    ...
    public void changeMessageOptionTest() throws IOException {
        ...
        Assert.assertEquals(OptionChangeInfo.OptionChangeType.OPTION_PAYLOAD_CHANGED, optionChangeInfo.getChangeType());
        Assert.assertEquals(OptionChangeInfo.OptionType.MESSAGE_OPTION, optionChangeInfo.getType());
    ...
    public void addFieldOptionTest() throws IOException {
        ...
        OptionChangeInfo optionChangeInfo = messageResult.getFieldResults(0).getOptionChangeList().get(0);
